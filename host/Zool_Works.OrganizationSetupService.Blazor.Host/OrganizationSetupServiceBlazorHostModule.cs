...
namespace Zool_Works.OrganizationSetupService.Blazor.Host
{
    [DependsOn(
        ...
        typeof(OrganizationSetupServiceBlazorModule)
    )]
    public class OrganizationSetupServiceBlazorHostModule : AbpModule
    {
        ...
        private void ConfigureRouter(ServiceConfigurationContext context)
        {
            ...
            {
                options.AppAssembly = typeof(OrganizationSetupServiceBlazorHostModule).Assembly;
            });
        }
        ...
        private void ConfigureMenu(ServiceConfigurationContext context)
        {
            ...
            {
                options.MenuContributors.Add(new OrganizationSetupServiceHostMenuContributor());
            });
        }
        ...
        private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
        {
            builder.Services.AddOidcAuthentication(options =>
            {
                ...
                options.ProviderOptions.DefaultScopes.Add("OrganizationSetupService");
            });
        }
        ...
        private void ConfigureAutoMapper(ServiceConfigurationContext context)
        {
            ...
            {
                options.AddMaps<OrganizationSetupServiceBlazorHostModule>();
            });
        }
    }
}
